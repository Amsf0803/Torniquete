...
Si deseas contribuir a este proyecto, por favor crea un *fork* del repositorio, crea una nueva rama para tus cambios y envía un *Pull Request*. Toda mejora a la lógica de validación, la programación del hardware o a la interfaz gráfica es bienvenida.
